                ...
                <CardContent className="space-y-4 flex-grow flex flex-col">
                  ...
                  <div className="flex gap-3 pt-2 mt-auto">
                    <motion.div 
                      ...
                      className="flex-1"
                    >
                      <Button asChild size="sm" className="w-full bg-transparent hover:bg-gray-900/20 text-white border border-black hover:border-gray-600 transition-all duration-200">
                        <a href={project.appStore} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
                    ...
                    <motion.div 
                      ...
                      className="flex-1"
                    >
                      <Button asChild size="sm" className="w-full bg-transparent hover:bg-green-600/20 text-white border border-green-600 hover:border-green-500 transition-all duration-200">
                        <a href={project.playStore} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
                          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
